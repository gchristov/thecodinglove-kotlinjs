...
data class Environment(
    ...
    val slackSelfDestructMessagePubSubTopic: String,
) {
    companion object {
        fun of(args: Array<String>) = with(parseMainArgs(args)) {
            Environment(
                ...
                slackSelfDestructMessagePubSubTopic = requireNotNull(this["-slackSelfDestructMessagePubSubTopic"]) { "-slackSelfDestructMessagePubSubTopic not specified." }.first(),
            )
        }
    }
}